...
class PrettyPrinter extends LogPrinter {
  ...
  List<String> log(LogEvent event) {
    ...
    if (event.stackTrace == null) {
      if (methodCount > 0) {
        stackTraceStr = formatStackTrace(StackTrace.current, methodCount, methodOffset);
      }
  ...
  String formatStackTrace(StackTrace stackTrace, int methodCount, int methodOffset) {
    ...
    if (formatted.isEmpty) {
      ...
      formatted.removeRange(0, methodOffset);
